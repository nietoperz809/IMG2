...
public class NPExecutor implements Executor {
    ...
    public NPExecutor(int count, int capacity) {
        ...
        Runnable commonProcedure = () -> {
            try {
                ...
                System.err.println (e + " -- " + Thread.currentThread ().getName ());
            }
        };
        while (count-- > 0) {
     ...
     */
    public ArrayList<Runnable> forceDown() throws InvocationTargetException, NoSuchMethodException, IllegalAccessException {
