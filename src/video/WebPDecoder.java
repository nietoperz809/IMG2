...
public class WebPDecoder implements Decoder {
     ...
     *  is used). Extracts the platform dependent library from
...
//            throw new RuntimeException(e);
//        }
//        String in = "C:\\peter.home\\java\\WebPDecoderJN\\animated-webp-supported.webp";
//        ImageResult result = getImage(in, 1);
